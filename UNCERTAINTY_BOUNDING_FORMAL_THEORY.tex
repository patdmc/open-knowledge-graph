...
about world state \(w\) is the conditional entropy {[}Shannon1948,
Cover2006{]}:
...
interpreted as a Bayesian network {[}Pearl1988{]}. \(P(w \mid K)\) is
...
with physics {[}Schrodinger1944{]}. Physical entropy and information
...
{[}Chalmers1995{]}. Whether the functional condition defined here is
...
independent action-validation accumulates {[}Peirce1877, Peirce1878{]}.
Formally:
...
\item
  ...
  {[}Hinton1987{]}. Is there an \(M^n\) for arbitrary \(n\)? Is there a
