...
\textbf{Formulation 1 (informal description):} ``intrinsic drive to
reduce uncertainty'' is a metaphorical gloss on Formulation 3; it
conveys the phenomenology but is not the definition. \textbf{Formulation
2 (empirical operationalization):} \(\mathcal{A}(E) \propto
...
grounding. Convergence of the \((M+1)\)-dimensional system follows from:
