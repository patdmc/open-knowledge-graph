...
Theorem~\ref{thm:type} establishes that the action space $A$ and the
higher-order function space $M$ are type-irreducible.
...
\label{cor:roles}
Type irreducibility establishes distinct functional roles:
