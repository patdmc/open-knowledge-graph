...
constitutively determined by $A$). These results engage with recent proposals to give observation and action separate
training objectives \cite{DupouxLeCunMalik2026}. Such separation violates a structural constraint imposed by bounded context.
\end{abstract}
