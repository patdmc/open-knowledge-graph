...
CHANNEL_MAP = {
    ...
    "STAT1": "Immune",
    "CD274": "Immune",  # PD-L1
    "PDCD1LG2": "Immune",  # PD-L2
    "CTLA4": "Immune",

    # Tissue architecture channel (adhesion, Wnt, Notch, TGF-beta)
    "CDH1": "TissueArch", "CDH2": "TissueArch",
    "CTNNB1": "TissueArch",  # beta-catenin
    "APC": "TissueArch",
    ...
    "FBXW7": "TissueArch",
    "GJA1": "TissueArch",  # Connexin 43
    "GJB2": "TissueArch",  # Connexin 26
}
