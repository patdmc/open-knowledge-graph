...
22	DRIVER: True if passing the driver filters. See documentation about the driver filters applied. 
23	FILTER: Category of the according to their filters: 
        ...
        "Samples with more than 2 mutations": The gene is filtered because there are samples with more than two mutations and it is not a driver gene, 
