...
\title{Uncertainty Bounding as the Basis of Intelligence: An Extension of the Free Energy Principle}
...
The Free Energy Principle \cite{Friston2010} is the most ambitious
...
attention under one formalism. Active inference \cite{Friston2017}
...
manage \cite{Friston2010,Friston2017}. Growing \(C_n\) adds variance:
...
\cite{Friston2021} model multiple agents with shared generative
