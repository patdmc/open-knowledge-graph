...
self-attention) converge toward graph-like structure under scale,
consistent with the optimality claim. The result is substrate-independent, applying
...
converge toward graph structure dynamically, consistent with the
optimality claim. They pay $O(n^2)$ per inference step to
