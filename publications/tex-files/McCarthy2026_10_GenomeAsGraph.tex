...
\begin{abstract}
The bounded context architecture paper of this series derive the structural constraints any
...
Paper~1 \cite{McCarthy2026_BCA}, instantiated in biochemistry.
...
The three encoding layers from Paper~4 \cite{McCarthy2026_BCA} map
directly:
...
$O(1)$ governance per instance (Paper~1 \cite{McCarthy2026_BCA}). No
...
This paper is the existence proof. The bounded context architecture paper derive from first
