...
present work is complementary. Rather than proposing what intelligent
systems should contain, we derive what they \emph{must} contain under
bounded context. The graph structure derived here also implies that
information could flow bidirectionally between observation and action,
not unidirectionally from perception to response.
...
increase---factoring adds a shared node---but context load decreases
